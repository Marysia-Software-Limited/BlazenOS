...
reads the ring (:class:`blazend.audio.RingReader`) for both wake- and
...
from blazend.led import BLUE, GREEN, MAGENTA, OFF
from blazend.led_hw import NullStatusLed, StatusLed

log = logging.getLogger("blazend.voice")
...
class TranscriberLike(Protocol):
    """Subset of :class:`blazend.asr.engine.Transcriber` the runner drives."""
