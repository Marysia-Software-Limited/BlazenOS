...
by :class:`blazend.domains.ai_orchestrator.adapters.rpi5.assistant.engine.Assistant` to retrieve the user's stored
...
:mod:`blazend.domains.local_ai.adapters.rpi5.localllm`. Tests inject a fake via the ``EmbedderLike``
...
def models_root() -> Path:
    """On-disk model tree. Mirrors :func:`blazend.domains.local_ai.adapters.rpi5.localllm.models_root`."""
