...
The on-device counterpart to :class:`blazend.domains.ai_orchestrator.adapters.rpi5.assistant.gemini.GeminiClient`:
...
like :mod:`blazend.domains.voice_input.adapters.rpi5.asr.engine`.
"""
...
class Llm(Protocol):
    ...
    :class:`blazend.domains.ai_orchestrator.adapters.rpi5.assistant.ollama.OllamaLlm` (the dev LAN-GPU backend)."""
