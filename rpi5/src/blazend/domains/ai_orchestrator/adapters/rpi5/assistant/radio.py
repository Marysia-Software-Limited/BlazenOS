...
(:class:`blazend.domains.voice_input.adapters.rpi5.voice.runner.StreamPlayer`) — the engine only routes.
"""
...
# Polish fold/stem helpers moved to the shared domains lib (domains for common
# code). Re-exported here so ``music.py`` and other callers keep importing them
# from this module unchanged.
from audiobook_catalog.text_norm import _fold, _stem_phrase, _stem_token  # noqa: F401
