...
TOPIC_NLU_MISS = "nlu.miss"
TOPIC_BRAIN_REQUEST = "brain.request"
TOPIC_BRAIN_REPLY = "brain.reply"
TOPIC_TOOL_REQUEST = "tool.request"
TOPIC_TOOL_RESPONSE = "tool.response"
...
ALL_TOPICS: tuple[str, ...] = (
    ...
    TOPIC_NLU_INTENT, TOPIC_NLU_MISS,
    TOPIC_BRAIN_REQUEST, TOPIC_BRAIN_REPLY,
    TOPIC_TOOL_REQUEST, TOPIC_TOOL_RESPONSE,
